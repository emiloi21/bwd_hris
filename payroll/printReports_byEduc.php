                ...
                <hr />
                    ...
                    <table id="" class="display" style="width:100%">
                          ...
                          <tbody>
                            ...
                            <td>
                                    <?php
                                    //echo $peb_row['personnel_id'];
                                    
                                    if(!empty($printDA_row)){
