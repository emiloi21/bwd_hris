        ...
        <div class="container-fluid">
          <div class="row page-title-block align-items-center">
            <div class="col-lg-8 col-md-8">
              <h2>Log Validation Viewer</h2>
              <p>Review and validate captured time-log images by flow</p>
            </div>
            <div class="col-lg-4 col-md-4 text-right page-cta-group">
              <a class="btn btn-primary" style="color: white; font-weight: bold;" href="log_validation_viewer.php">AM IN</a>
              ...
              <a class="btn btn-outline-primary" href="log_validation_viewer_PM_OUT.php">PM OUT</a>
            </div>
          </div>
        </div>
      </section>
            ...
            <!-- kinder 1     -->
              <div id="new-updates" class="card updates recent-updated">
                ...
                <table id="" class="display" style="width:100%">
                      ...
                      $new_clearance_query = $conn->query("SELECT * FROM personnel_logs WHERE logDate='$filterDate' AND logFlow='AM IN' AND (remarks='Inserted' OR remarks='Updated' OR remarks='') ORDER BY log_id ASC");
