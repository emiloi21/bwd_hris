...
<body>
    ...
    $studLogs_AM_OUT_stmt->execute([':RFTag_id' => $_GET['RFTag_id'] ?? '', ':logDate' => $logDateCtr]);
...
?>
    ...
    $sched_stmt->execute([':do_id' => $studData_row['do_id'], ':shift_id' => $studLogs_AM_OUT_row['shift_id'], ':day' => $dayName]);
...
<tr>
        ...
        $studLogs_PM_IN_stmt->execute([':RFTag_id' => $_GET['RFTag_id'] ?? '', ':logDate' => $logDateCtr]);
  ...
  <td <?php if($SC_query3->rowCount()>0){?> rowspan="2" <?php } ?> >
    ...
    $studLogs_remarks_stmt->execute([':RFTag_id' => $_GET['RFTag_id'] ?? '', ':logDate' => $logDateCtr]);
    ...
    $studLogs_sat_stmt->execute([':RFTag_id' => $_GET['RFTag_id'] ?? '', ':logDate' => $logDateCtr]);
    ...
    $studLogs_AM_IN_stmt->execute([':RFTag_id' => $_GET['RFTag_id'] ?? '', ':logDate' => $logDateCtr]);
    ...
    $studLogs_PM_OUT_stmt->execute([':RFTag_id' => $_GET['RFTag_id'] ?? '', ':logDate' => $logDateCtr]);
    ...
    if($studLogs_AM_IN_row['late_status']==='on'){
        ...
        $sched_stmt->execute([':do_id' => $studData_row['do_id'], ':shift_id' => $studLogs_AM_IN_row['shift_id'], ':day' => $dayName]);
        $sq_row=$sched_stmt->fetch();
    ...
    $studLogs_PM_OUT_chk_stmt->execute([':RFTag_id' => $_GET['RFTag_id'] ?? '', ':logDate' => $logDateCtr]);
    ...
    if(($studLogs_AM_IN_row['shift_id']===777 AND $studLogs_query_AM_IN->rowCount()>0) OR ($studLogs_PM_IN_row['shift_id']===777 AND $studLogs_query_PM_IN->rowCount()>0)){
    ...
    if($studLogs_PM_IN_row['late_status']==='on'){
        ...
        $sched_stmt->execute([':do_id' => $studData_row['do_id'], ':shift_id' => $studLogs_PM_IN_row['shift_id'], ':day' => $dayName]);
        $sq_row=$sched_stmt->fetch();
    ...
    if($studLogs_PM_OUT_row['late_status']=="on"){
        ...
        $sched_stmt->execute([':do_id' => $studData_row['do_id'], ':shift_id' => $studLogs_PM_OUT_row['shift_id'], ':day' => $dayName]);
        $sq_row=$sched_stmt->fetch();
    ...
    if(($studLogs_AM_IN_row['shift_id']===777 AND $studLogs_query_AM_IN->rowCount()>0) OR ($studLogs_PM_IN_row['shift_id']===777 AND $studLogs_query_PM_IN->rowCount()>0)){
        ...
        $dailyFinalHR = $dailyFinalHR ?? 0;
        echo ($dailyLate+$dailyUTime)-($dailyFinalHR*60);
    }
    ?>
    </td>
