...
<body>
                    ...
                    <table id="example" class="display" style="width:100%">
                          ...
                          <tbody>
                                ...
                                <?php
                                $list_ctr=0;
                                $printDataAge_query = $conn->query("SELECT personnel_id, lname, fname, mname, suffix, do_id, des_id, empStat_id FROM personnels WHERE sex='Male' AND (separation_date='' OR separation_date='  /  /    ') ORDER BY lname, fname") or die(mysql_error());
                   ...
                   <?php include('footer_print.php'); ?>
                    ...
                    <table id="example" class="display" style="width:100%">
                          ...
                          <tbody>
                                ...
                                <?php
                                $list_ctr=0;
                                $printDataAge_query = $conn->query("SELECT personnel_id, lname, fname, mname, suffix, do_id, des_id, empStat_id FROM personnels WHERE sex='Female' AND (separation_date='' OR separation_date='  /  /    ') ORDER BY lname, fname") or die(mysql_error());
                                while($printDA_row=$printDataAge_query->fetch()){
                   ...
                   <?php include('footer_print.php'); ?>
                    ...
                    <center>
                    <h3>PERSONNELS SCHOLASTIC DATA</h3>
                    <p style="font-size: medium;"><?php echo 'Degree: '.$degree.' | School: '.$school_name.''; ?></p>
                    </center>
                    <hr />
                    ...
                    <table id="example" class="display" style="width:100%">
                          ...
                          <tbody>
                                ...
                                <?php
                                $list_ctr=0;
                                $printDataAge_query = $conn->query("SELECT personnel_id, lname, fname, mname, suffix, do_id, des_id, empStat_id FROM personnels WHERE separation_date='' OR separation_date='  /  /    ' ORDER BY lname, fname") or die(mysql_error());
                                while($printDA_row=$printDataAge_query->fetch()){
