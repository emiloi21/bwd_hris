        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12 col-md-12">
                    ...
                    <a class="btn btn-primary" style="color: white; font-weight: bold;" href="log_validation_viewer_AM_OUT.php?crw=AGE">AM OUT</a>
                    <a class="btn btn-outline-primary" href="log_validation_viewer_PM_IN.php?crw=EDUCATION">PM IN</a>
                    <a class="btn btn-outline-primary" href="log_validation_viewer_PM_OUT.php?crw=GENDER">PM OUT</a>
                    </div>
            ...
            <!-- kinder 1     -->
              <div id="new-updates" class="card updates recent-updated">
                ...
                <table id="" class="display" style="width:100%">
                      ...
                      $new_clearance_query = $conn->query("SELECT * FROM personnel_logs WHERE logDate='$filterDate' AND logFlow='AM OUT' AND (remarks='Inserted' OR remarks='Updated' OR remarks='') ORDER BY log_id ASC");
