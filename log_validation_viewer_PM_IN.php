        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-12 col-md-12">
                    ...
                    <a class="btn btn-primary" style="color: white; font-weight: bold;" href="log_validation_viewer_PM_IN.php">PM IN</a>
            ...
            <!-- kinder 1     -->
              <div id="new-updates" class="card updates recent-updated">
                ...
                <table id="" class="display" style="width:100%">
                      ...
                      $new_clearance_query = $conn->query("SELECT * FROM personnel_logs WHERE logDate='$filterDate' AND logFlow='PM IN' AND (remarks='Inserted' OR remarks='Updated' OR remarks='') ORDER BY log_id ASC");
