...
<h1 style="font-weight: lighter; color: gray; width: 100%; text-align: center; margin-top: 200px;">This computer is not registered as Log Client</h1>
...
<div id="right">
    ...
    <div style="font-size: 52px; text-align: center; color: #000;" id="clock"> </div>
   
    <div id="screenRefDate" align="center" style="font-size: 32px; color: #000;"></div>
