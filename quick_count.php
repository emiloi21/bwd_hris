          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-md-8 col-12">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">EMPLOYEES <a href="print_all_personnel.php" target="_blank" title="Click to print all employees..."><i style="font-size: small;" class="fa fa-print"></i></a></strong>
            ...
            <div class="col-xl-2 col-md-8 col-12">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Shifts</strong>
                
                <span>Work Time Preferences</span>
