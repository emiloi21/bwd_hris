...
if($tr1_img==""){ 
    ...
    ?>
        ...
        <p style="padding: 10px 16px 12px 12px; font-size: x-large; float: right;">
                ...
                if($am_out_log_query->rowCount()>0){ echo "zx9"; }else{ ?>
                
                <!-- button trapping -->
                <?php if($time_seconds_current_time>=$time_seconds_am_out){ ?>
                
                
                <form method="POST" action="updateTap.php?RFTag_id=<?php echo $RFTag_id; ?>&do_idxx=<?php echo $do_idxx; ?>&log_id=<?php echo $log_id; ?>&logFlow=AM OUT" enctype="multipart/form-data">
                        ...
                        <table style="margin-top: 12px;" align="right">
                        <tr>
                        <td><button onclick="take_snapshot()" class="btn btn-info btn-sm" style="border: solid 2px white;">AM OUT</button></td>
                        <td>&nbsp;</td>
                        <td><a href="updateBlankLogFlow.php?toWindow=rlt1" class="btn btn-default btn-sm" style="border: solid 2px white; color: black;">Cancel</a></td>
                        </tr>
                        </table>
                ...
                <form method="POST" action="updateTap.php?RFTag_id=<?php echo $RFTag_id; ?>&do_idxx=<?php echo $do_idxx; ?>&log_id=<?php echo $log_id; ?>&logFlow=AM OUT" enctype="multipart/form-data">
                        ...
                        <table style="margin-top: 12px;" align="right">
                        <tr>
                        <td><button onclick="take_snapshot()" class="btn btn-warning btn-sm" style="border: solid 2px white; color: blue;">AM OUT</button></td>
                        <td>&nbsp;</td>
                        <td><a href="updateBlankLogFlow.php?toWindow=rlt1" class="btn btn-default btn-sm" style="border: solid 2px white; color: black;">Cancel</a></td>
                        </tr>
                        </table>
               ...
               <?php } } else { echo "no am in"; if($pil_row['logFlow']!=""){ echo "pm in log not = blank"; }else{ ?> 
               ...
               <!-- button trapping -->
                ...
                <form method="POST" action="updateTap.php?RFTag_id=<?php echo $RFTag_id; ?>&do_idxx=<?php echo $do_idxx; ?>&log_id=<?php echo $log_id; ?>&logFlow=AM IN&lateStat=off" enctype="multipart/form-data">
                        ...
                        <table style="margin-top: 12px;" align="right">
                        <tr>
                        <td><button onclick="take_snapshot()" class="btn btn-info btn-sm" style="border: solid 2px white;">AM IN</button></td>
                        <td>&nbsp;</td>
                        <td><a href="updateBlankLogFlow.php?toWindow=rlt1" class="btn btn-default btn-sm" style="border: solid 2px white; color: black;">Cancel</a></td>
                        </tr>
                        </table>
                ...
                <form method="POST" action="updateTap.php?RFTag_id=<?php echo $RFTag_id; ?>&do_idxx=<?php echo $do_idxx; ?>&log_id=<?php echo $log_id; ?>&logFlow=AM IN&lateStat=on" enctype="multipart/form-data">
                        ...
                        <table style="margin-top: 12px;" align="right">
                        <tr>
                        <td><button onclick="take_snapshot()" class="btn btn-warning btn-sm" style="border: solid 2px white; color: blue;">AM IN</button></td>
                        <td>&nbsp;</td>
                        <td><a href="updateBlankLogFlow.php?toWindow=rlt1" class="btn btn-default btn-sm" style="border: solid 2px white; color: black;">Cancel</a></td>
                        </tr>
                        </table>
                ...
                if($pm_out_log_query->rowCount()>0){ echo "pm out log has rcord"; }else{ ?> 
                
                <!-- button trapping -->
                <?php if($time_seconds_current_time>=$time_seconds_pm_out){ ?>
                
                
                <form method="POST" action="updateTap.php?RFTag_id=<?php echo $RFTag_id; ?>&do_idxx=<?php echo $do_idxx; ?>&log_id=<?php echo $log_id; ?>&logFlow=PM OUT" enctype="multipart/form-data">
                        ...
                        <table style="margin-top: 12px;" align="right">
                        <tr>
                        <td><button onclick="take_snapshot()" class="btn btn-info btn-sm" style="border: solid 2px white;">PM OUT</button></td>
                        <td>&nbsp;</td>
                        <td><a href="updateBlankLogFlow.php?toWindow=rlt1" class="btn btn-default btn-sm" style="border: solid 2px white; color: black;">Cancel</a></td>
                        </tr>
                        </table>
                ...
                <form method="POST" action="updateTap.php?RFTag_id=<?php echo $RFTag_id; ?>&do_idxx=<?php echo $do_idxx; ?>&log_id=<?php echo $log_id; ?>&logFlow=PM OUT" enctype="multipart/form-data">
                        ...
                        <table style="margin-top: 12px;" align="right">
                        <tr>
                        <td><button onclick="take_snapshot()" class="btn btn-warning btn-sm" style="border: solid 2px white; color: blue;">PM OUT</button></td>
                        <td>&nbsp;</td>
                        <td><a href="updateBlankLogFlow.php?toWindow=rlt1" class="btn btn-default btn-sm" style="border: solid 2px white; color: black;">Cancel</a></td>
                        </tr>
                        </table>
                ...
                <?php } }else{ echo "zx6"; if($am_in_log_query->rowCount()>0){
                ...
                <form method="POST" action="updateTap.php?RFTag_id=<?php echo $RFTag_id; ?>&do_idxx=<?php echo $do_idxx; ?>&log_id=<?php echo $log_id; ?>&logFlow=PM IN&lateStat=off&type=<?php echo $sSDQ_row['type']; ?>&pm_OUT=<?php echo $sSDQ_row['pm_OUT']; ?>&am_IN=<?php echo $sSDQ_row['am_IN']; ?>" enctype="multipart/form-data">
                        ...
                        <table style="margin-top: 12px;" align="right">
                        <tr>
                        <td><button onclick="take_snapshot()" class="btn btn-info btn-sm" style="border: solid 2px white;">PM IN</button></td>
                        <td>&nbsp;</td>
                        <td><a href="updateBlankLogFlow.php?toWindow=rlt1" class="btn btn-default btn-sm" style="border: solid 2px white; color: black;">Cancel</a></td>
                        </tr>
                        </table>
                ...
                <form method="POST" action="updateTap.php?RFTag_id=<?php echo $RFTag_id; ?>&do_idxx=<?php echo $do_idxx; ?>&log_id=<?php echo $log_id; ?>&logFlow=PM IN&lateStat=on&type=<?php echo $sSDQ_row['type']; ?>&pm_OUT=<?php echo $sSDQ_row['pm_OUT']; ?>&am_IN=<?php echo $sSDQ_row['am_IN']; ?>" enctype="multipart/form-data">
                        ...
                        <table style="margin-top: 12px;" align="right">
                        <tr>
                        <td><button onclick="take_snapshot()" class="btn btn-warning btn-sm" style="border: solid 2px white; color: blue;">PM IN</button></td>
                        <td>&nbsp;</td>
                        <td><a href="updateBlankLogFlow.php?toWindow=rlt1" class="btn btn-default btn-sm" style="border: solid 2px white; color: black;">Cancel</a></td>
                        </tr>
                        </table>
                ...
                <?php } echo "zx2"; } echo "zx3"; } echo "zx4"; ?>
